...
public:
	...
	BasePanel(Panel *parent, const char *name) : Panel(parent, name)
	{
...
class HeaderPanel : public BasePanel
{
	DECLARE_CLASS_SIMPLE( HeaderPanel, BasePanel );

	HeaderPanel(Panel *parent, const char *name);
...
class PanelList : public vgui::Panel
{
	DECLARE_CLASS_SIMPLE( PanelList, vgui::Panel );

public:
	PanelList(Panel *parent, const char *name);
	~PanelList();
...
//	void RemovePanel( int index );
	...
	Panel * GetSelectedPanel(){ return GetPanel(m_iSelected); }
...
private:
	...
	BasePanel *m_pSelImage;

	bool m_bPaintBg;
};

class CAdvModelPanel;

class SubPanel : public BasePanel
{
	DECLARE_CLASS_SIMPLE( SubPanel, BasePanel );

	SubPanel(Panel *parent, const char *name, const char* modelName, const char* title, int slot);
