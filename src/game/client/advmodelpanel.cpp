...
void CAdvModelPanel::Update()
{
	...
	if ( m_iAnimationIndex < m_BMPResData.m_aAnimations.Count() )
	{
...
/*
void CAdvModelPanel::SetupCustomLights( Color cAmbient, Color cKey, float fKeyBoost, Color cRim, float fRimBoost )
{
